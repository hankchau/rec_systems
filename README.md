...
The implementations of the models here are my own work, but the Neural Network based model concepts are based on *"Neural Collaborative Filtering"* by Xiangnan He, Lizi Liao et al, 2017. 
